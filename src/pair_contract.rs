...
use ethers::contract::{abigen, Contract, EthEvent};
use ethers::prelude::*;
use ethers::prelude::{Event, Http, Middleware, Provider};
use ethers::providers::Ws;
use ethers::types::{Address, BlockId, BlockNumber, Filter, Log, U256};
...
//     let event = contract.event::<SwapEvent>();
...
//     sushiswap_pair_contract: SushiswapV2Pair<Provider<Http>>,
